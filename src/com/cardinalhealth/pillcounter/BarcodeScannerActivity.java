...
public class BarcodeScannerActivity extends Activity implements ScanditSDKListener {
    ...
    public static final String sScanditSdkAppKey = "6d48oAI7EeSIaznBR58fjCKRbzGDqLGulYvqwOllOHk";
...
//        mBarcodePicker.setEan13AndUpc12Enabled(false);
        mBarcodePicker.setEan8Enabled(false);
//        mBarcodePicker.setUpceEnabled(false);
        mBarcodePicker.setCode39Enabled(false);
        mBarcodePicker.setCode128Enabled(false);
        mBarcodePicker.setItfEnabled(false);
        mBarcodePicker.setMsiPlesseyEnabled(false);
        mBarcodePicker.setGS1DataBarEnabled(false);
        mBarcodePicker.setQrEnabled(false);
        mBarcodePicker.setDataMatrixEnabled(false);
        mBarcodePicker.setPdf417Enabled(false);
    ...
    public void didScanBarcode(String barcode, String symbology) {
        ...
        Intent nextIntent = new Intent(this,OnlineInventoryActivity.class);
        getBarcodeData(cleanedBarcode, nextIntent);
        didCancel();
